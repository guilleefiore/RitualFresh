...
import com.ritualfresh.auth.RegistroUsuarioRequest;
import com.ritualfresh.auth.ResultadoInicioSesionUsuario;
import com.ritualfresh.auth.ResultadoRegistroUsuario;
import com.ritualfresh.auth.RolUsuario;
import com.ritualfresh.auth.SesionUsuarioRepositorio;
import com.ritualfresh.auth.SesionUsuarioRepositorioEnMemoria;
import com.ritualfresh.auth.Usuario;
import com.ritualfresh.auth.UsuarioRepositorio;
import com.ritualfresh.auth.UsuarioRepositorioEnMemoria;
import com.ritualfresh.auth.UsuarioServicio;
...
class PerfilServicioTest {
    ...
    private ResultadoInicioSesionUsuario registrarValidarEIniciarSesionCliente() {
        ...
        return usuarioServicio.iniciarSesion(new com.ritualfresh.auth.InicioSesionRequest(usuario.getMail(), "clave123"));
    }
